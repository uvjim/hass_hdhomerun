...
class OptionalHDHomeRunSelectDescription:
    ...
    hdhomerun_options: Callable[[Any], list[str]] | list[str] = dataclasses.field(
...
class HDHomeRunSelect(HDHomerunEntity, SelectEntity):
    ...
    def options(self) -> List[str] | None:
        ...
        if isinstance(self.entity_description.hdhomerun_options, Callable):
            return self.entity_description.hdhomerun_options(self.coordinator.data)

        return self.entity_description.hdhomerun_options
